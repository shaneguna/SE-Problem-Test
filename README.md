...
## About This App
# Configuration
Note: requires Docker Desktop to run, uses Laravel Sail as an out-of-the-box solution for dockerization.

Clone and install by running command `<projectRoot>./vendor/bin/sail up --build`
